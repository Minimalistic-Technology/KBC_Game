...
// --- RESTORED QUESTION DATA FOR OTHER PAGES ---
...
export const allQuestions: Question[] = [ 
  { id: 101, level: 1, bankId: 'q1', question: 'What is the capital of France?', options: ['Berlin', 'Madrid', 'Paris', 'Rome'], answer: 'Paris', status: 'Published', tags: ['Geography'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 102, level: 1, bankId: 'q1', question: 'Which planet is known as the Red Planet?', options: ['Earth', 'Mars', 'Jupiter', 'Venus'], answer: 'Mars', status: 'Published', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 103, level: 1, bankId: 'q1', question: 'Who wrote "To Kill a Mockingbird"?', options: ['Harper Lee', 'Mark Twain', 'J.K. Rowling', 'F. Scott Fitzgerald'], answer: 'Harper Lee', status: 'Published', tags: ['Literature'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 201, level: 2, bankId: 'q1', question: 'What is the largest ocean on Earth?', options: ['Atlantic', 'Indian', 'Arctic', 'Pacific'], answer: 'Pacific', status: 'Published', tags: ['Geography'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 202, level: 2, bankId: 'q1', question: 'In what year did the Titanic sink?', options: ['1905', '1912', '1918', '1923'], answer: '1912', status: 'Published', tags: ['History'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 203, level: 2, bankId: 'q1', question: 'What is the chemical symbol for gold?', options: ['Ag', 'Au', 'Pb', 'Fe'], answer: 'Au', status: 'Published', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 301, level: 3, bankId: 'q1', question: 'Who was the first person to step on the moon?', options: ['Buzz Aldrin', 'Yuri Gagarin', 'Neil Armstrong', 'Michael Collins'], answer: 'Neil Armstrong', status: 'Published', tags: ['History'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': false } },
  { id: 302, level: 3, bankId: 'q1', question: 'What is the hardest natural substance on Earth?', options: ['Gold', 'Iron', 'Diamond', 'Platinum'], answer: 'Diamond', status: 'Published', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': false } },
  { id: 303, level: 3, bankId: 'q1', question: 'Which country is known as the Land of the Rising Sun?', options: ['China', 'Japan', 'Thailand', 'South Korea'], answer: 'Japan', status: 'Published', tags: ['Geography'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': false } },
  
  { id: 104, level: 1, bankId: 'q2', question: 'What does CPU stand for?', options: ['Central Processing Unit', 'Computer Personal Unit', 'Central Process Unit', 'Control Process Unit'], answer: 'Central Processing Unit', status: 'Draft', tags: ['Tech'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 105, level: 1, bankId: 'q2', question: 'What is the chemical formula for water?', options: ['O2', 'H2O', 'CO2', 'NaCl'], answer: 'H2O', status: 'Draft', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 106, level: 1, bankId: 'q2', question: 'Which force keeps us on the ground?', options: ['Magnetism', 'Friction', 'Gravity', 'Tension'], answer: 'Gravity', status: 'Draft', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 204, level: 2, bankId: 'q2', question: 'What is the powerhouse of the cell?', options: ['Nucleus', 'Ribosome', 'Mitochondrion', 'Chloroplast'], answer: 'Mitochondrion', status: 'Draft', tags: ['Biology'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 205, level: 2, bankId: 'q2', question: 'What does "www" stand for in a website browser?', options: ['World Wide Web', 'Web World Wide', 'World Web Wide', 'Wide World Web'], answer: 'World Wide Web', status: 'Draft', tags: ['Tech'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 206, level: 2, bankId: 'q2', question: 'How many planets are in our solar system?', options: ['7', '8', '9', '10'], answer: '8', status: 'Draft', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': true, 'Expert Advice': true } },
  { id: 304, level: 3, bankId: 'q2', question: 'Who is credited with inventing the telephone?', options: ['Thomas Edison', 'Nikola Tesla', 'Alexander Graham Bell', 'Guglielmo Marconi'], answer: 'Alexander Graham Bell', status: 'Draft', tags: ['History', 'Tech'], lifelines: { '50:50': true, 'Audience Poll': false, 'Expert Advice': false } },
  { id: 305, level: 3, bankId: 'q2', question: 'What is the speed of light?', options: ['300,000 km/s', '150,000 km/s', '500,000 km/s', '1,000,000 km/s'], answer: '300,000 km/s', status: 'Draft', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': false, 'Expert Advice': false } },
  { id: 306, level: 3, bankId: 'q2', question: 'What is the main component of the sun?', options: ['Oxygen', 'Nitrogen', 'Hydrogen', 'Carbon'], answer: 'Hydrogen', status: 'Draft', tags: ['Science'], lifelines: { '50:50': true, 'Audience Poll': false, 'Expert Advice': false } },
];