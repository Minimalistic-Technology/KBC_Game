  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <button className="px-4 py-2 w-full sm:w-auto font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors inline-flex items-center justify-center gap-2">
          <PlusCircle size={16} /> Add New
        </button>
      </div>

      <div className="mb-6 bg-white p-3 rounded-xl shadow-sm border border-slate-200 flex flex-wrap items-center gap-2">
