            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4 items-end">
                <div className="md:col-span-1">
                    ...
                    <select id="bankSelect" className="w-full h-10 px-3 border bg-white border-slate-300 rounded-lg text-slate-900">
                        ...
                        {allBanks.map(bank => <option key={bank.id} value={bank.id}>{bank.title}</option>)}
                    </select>
                </div>
                <div className="md:col-span-1">
                ...
                <div className="md:col-span-1">
                    <button onClick={handleExport} className="w-full inline-flex items-center justify-center gap-2 rounded-lg border bg-white px-4 h-10 text-sm font-semibold text-slate-800 hover:bg-slate-100">
