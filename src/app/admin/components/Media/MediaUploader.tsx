...
interface MediaUploaderProps {
  onUploadComplete: (asset: MediaAsset, rawFile?: File) => void; // now returns raw file too
  accept: Accept;
}
...
export const MediaUploader = ({ onUploadComplete, accept }: MediaUploaderProps) => {
  ...
  const handleUpload = async (acceptedFile: File) => {
    ...
    // Pass both the processed MediaAsset and raw file
    onUploadComplete(newAsset, acceptedFile);
