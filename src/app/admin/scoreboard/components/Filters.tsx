  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <select
        ...
        className="rounded-lg border bg-white px-3 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 flex-shrink-0"
      >
      ...
      <div ref={calendarRef} className="relative flex items-center rounded-lg border bg-white focus-within:ring-2 focus-within:ring-indigo-500 transition-all duration-150 flex-shrink-0">
        <button
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 flex-shrink-0"
      >
